...
import { LayoutDashboard, LogOut, PanelLeft, Users, Briefcase, FileText, Zap, Cpu } from "lucide-react";
...
const menuItems = [
  ...
  { icon: FileText, label: "Responsáveis Técnicos", path: "/responsaveis" },
  { icon: Zap, label: "Módulos Fotovoltaicos", path: "/modulos" },
  { icon: Cpu, label: "Inversores", path: "/inversores" },
];
